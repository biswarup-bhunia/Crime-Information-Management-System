...
public class CrimesStatusUsecase4 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			System.out.println("Press & Enter case_no of crime - file ");
			n = sc.nextInt();
			System.out.println("Press & Enter 1  change to solved ");
			System.out.println("Press & Enter 2  change to unsolved ");
