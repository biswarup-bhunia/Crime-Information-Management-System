...
public class Criminal {
	...
	public String toString() {
		System.out.println();
		return "********* Criminal -> Criminal-Id=" + cri_Id + ", Criminal-Name=" + cri_name + ",Criminal-Age=" + Age
				+ ", Gender=" + gender + "\n" + "Address=" + address + ", Identification-Mark=" + Identification
				+ ", Area_of_crime=" + Area_of_crime + "\n" + ", Crime_file-No=" + crime_file + ", Area_pincode="
				+ area_pincode + "] *********";
	}
